...
import GoalSelector from "@/components/mentorship/goal-selector"

import MatchCard from "@/components/mentorship/match-card"
import MentorshipBreadcrumb from "@/components/mentorship/mentorship-breadcrumb"
import SessionRequestModal, { type SessionRequestData } from "@/components/mentorship/session-request-modal"
import Card from "@/components/ui/card"
import { Bot, Filter, RefreshCw, SlidersHorizontal, Star } from "lucide-react"
            ...
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-1">
                ...
                <div className="space-y-2 text-sm text-gray-700">
                  <p>• Based on your DevOps focus, I found <strong>{filteredMatches.length} compatible
                                                                                            mentors</strong> matching
                     your criteria</p>
                  <p>• <strong>Rajesh Hamal</strong> has the most similar learning path to your goals</p>
                  <p>• Consider scheduling sessions during <strong>Nepal evening hours</strong> for better availability
                  </p>
                  <p>• Your profile shows strong potential for <strong>advanced DevOps practices</strong> - these
                     mentors can help you get there</p>
                </div>
              </div>
            </div>
          </Card>
