...
import { Code, TrendingUp, Briefcase, GraduationCap, Bot } from 'lucide-react';
        ...
        <div className="bg-purple-50 p-4 rounded-lg">
          ...
          <div className="flex flex-wrap gap-2">
            {selectedGoals.map((goalId) => {
              ...
              return (
                <div key={goalId} className="flex items-center space-x-1 bg-white px-3 py-1 rounded-full border border-purple-200">
                  {goal.icon}
