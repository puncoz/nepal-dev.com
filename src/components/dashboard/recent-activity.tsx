...
import { Award, Briefcase, Calendar, Code, ExternalLink, Heart, MessageCircle, UserPlus } from "lucide-react"
          ...
          <div className="flex-1">
            ...
            {activity.user && (
              <div className="flex items-center space-x-2 mb-2">
                <div
                  className="w-6 h-6 bg-gradient-to-r from-blue-500 to-green-500 rounded-full flex items-center justify-center">
